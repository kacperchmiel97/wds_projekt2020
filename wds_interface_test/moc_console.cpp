...
QT_MOC_LITERAL(1, 8, 8), // "lineRead"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 1), // "x"
QT_MOC_LITERAL(4, 20, 1), // "y"
QT_MOC_LITERAL(5, 22, 1), // "r"
QT_MOC_LITERAL(6, 24, 8) // "readOnce"

    },
    "console\0lineRead\0\0x\0y\0r\0readOnce"
};
...
void console::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->lineRead((*reinterpret_cast< float(*)>(_a[1])),(*reinterpret_cast< float(*)>(_a[2])),(*reinterpret_cast< float(*)>(_a[3]))); break;
        case 1: _t->readOnce(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&console::lineRead)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void console::lineRead(float _t1, float _t2, float _t3)
{
